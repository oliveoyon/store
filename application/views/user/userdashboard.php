    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?=site_url('user');?>"><i class="fa fa-user"></i> Dashboard</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <a href="<?=site_url('user/view_recipient');?>">
          <div class="info-box">
        ...
        <!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12">
          <a href="<?=site_url('user/view_product');?>">
          <div class="info-box">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <a href="<?=site_url('user/view_category');?>">
          <div class="info-box">
