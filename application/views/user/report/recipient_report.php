            ...
            <form class="form-horizontal" method="POST" action="#">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select name="recipient_id" class="selectpicker form-control" required data-live-search="true">
                        <option value="all">--Select Recipient--</option>
                      <?php foreach ($recipient as $rec) {?>
                        <option value="<?=$rec['recipient_id'];?>"><?=$rec['recipient_name'];?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
        ...
        <div class="col-md-8">
          <div class="box">
            <div class="box-header text-center">
              <h3 class="box-title text-center">Product Issued To></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
