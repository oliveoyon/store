        ...
        <div class="col-md-6">
          <div class="box box-info">
            <div class="box-header with-border">
              <a href="<?=site_url('user/view_product');?>" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> View Product</a> <br><br>
            ...
            <form class="form-horizontal" method="POST" action="#">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" id="inputEmail3" name="product_name" required placeholder="Product Name" type="text">
                  </div>
                </div>
                <div class="form-group">
