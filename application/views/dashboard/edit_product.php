          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="POST" action="#">
              <div class="box-body">
				...
				<div class="form-group">
                  <label for="inputEmail3" class="col-sm-3 control-label">Total Qty</label>

                  <div class="col-sm-9">
                    <input class="form-control" id="inputEmail3" name="total_qty"  value="<?=$data[0]['total_qty'];?>" type="text">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input class="form-control" id="inputEmail3" name="remarks"  value="<?=$data[0]['remarks'];?>" type="text">
                  </div>
                </div>
                <div class="form-group">
